<%@ page language="java" import="java.util.*,com.util.MD5Util" pageEncoding="utf-8"%>
<%@ page isELIgnored="false" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"> 
<html>
  <head>
    
    <title>JUNGLE支付</title>
  ...
  <body>
    ...
    <%	
    	...
    	String notify_url = "http://localhost:8888/JUNGLE/Receive.jsp";
    	String return_url = "http://localhost:8888/JUNGLE/Receive.jsp";
    	/*存数据库 对应的订单号*/
