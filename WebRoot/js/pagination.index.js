   		...
   		$.post("article.do","method=AllArticleCount",function(rowCount){
    		...
    		$("#Pagination").pagination(rowCount, {  
		         callback: indexPageCallback,  //回调函数  用来加载某一页的数据的Ajax的方法
    	...
    	function indexPageCallback(pageIndex,jq){
	    		...
	    		$(list).each(function(){
	    			...
	    			$("#main").append(
	    	    			...
	    	    			//未加编辑以及删除链接，后期可通过验证用户id与session的用户id决定是否有修改链接
	    	    				...
	    	    				+"<div class='aw-question-content'><h4><a style='list-style: none;text-decoration:none;' href='article-"+this.article_id+".html' ><b>"
	    	    				+this.article_title+"</b>  &nbsp;&nbsp;<i class='label label-warning'>"
	    	    				+this.article_tag+"</i></a></h4><a href='article-"+this.article_id+".html' ><i class='has-success'>"
	    	    				+new_article_content+"</i></a><p><a href='tempuserUrl' class='aw-user-name'>"
